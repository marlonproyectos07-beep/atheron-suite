...
casaCompleta:
  ...
  cejaHabitaciones: '¿Prefieres una habitación?'
  tituloHabitaciones: Conoce las cinco opciones
  introHabitaciones: Compara primero y entra solo a la habitación que te interese.
habitaciones:
  ...
  - nombre: Habitación 202
    ...
    galeria:
      ...
      - imagen: /assets/img/hospedajes/hotel-atheron-suite-202-camarote.jpg
        alt: Camarote de la habitación 202 con dos camas sencillas, visto desde la entrada
  ...
  - nombre: Suite 301
    ...
    video:
      ...
      titulo: 'Suite 301 · Experiencia inteligente: una habitación que puedes controlar con tu voz'
  ...
  - nombre: Habitación 302
    ...
    galeria:
      - imagen: /assets/img/hospedajes/hotel-atheron-suite-302-fachada.jpg
        alt: Fachada del Hotel Atheron Suite en la Carrera 9 de Zipaquirá, edificio de tres pisos con el aviso del hotel
...
distancias:
  ...
  - lugar: Centro Comercial Andino (Bogotá)
    valor: 43 km
    pendiente: false
  - lugar: Estadio El Campin (Bogotá)
    valor: 46 km
    pendiente: false
...
mapaTitulo: 'Mapa con la ubicación del Hotel Atheron Suite en la Cra. 9 #10-32 de Zipaquirá'
enlaceMapa: 'https://maps.app.goo.gl/v8SN7csVkdZiFF9WA'
nombreAnterior: Hospedaje La Magia de Zipaquirá
mapaNota: ''
...
datosContacto:
  - 'Cra. 9 #10-32, Zipaquirá, Cundinamarca'
