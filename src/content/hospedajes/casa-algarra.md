...
galeria:
  ...
  - imagen: /assets/img/hospedajes/casa-algarra/casa-algarra-03-sala-escalera.webp
    alt: Vista a lo largo de la sala de Casa Algarra, con la escalera al segundo piso
  - imagen: /assets/img/hospedajes/casa-algarra/casa-algarra-04-cocina-general.webp
    alt: Cocina equipada de Casa Algarra, con estufa y espacio de trabajo
...
datos:
  ...
  - numero: '5'
    ...
    pendiente: false
  - numero: '2'
    texto: Carros en parqueadero
    pendiente: false
tituloDescripcion: Una casa entera, para que nadie se quede fuera
tituloDescripcionPendiente: false
caracteristicas:
  - texto: Casa completa para grupos y familias, hasta 22 personas
    pendiente: false
  ...
  - texto: Cocina equipada con estufa, nevera y utensilios
    pendiente: false
  - texto: Sala y comedor para reunirse
    pendiente: false
  - texto: Wifi
    pendiente: false
  - texto: TV con Netflix
    pendiente: false
  - texto: Agua caliente
    pendiente: false
...
por persona; por debajo de ocho, la tarifa es de $65.000 por persona.
