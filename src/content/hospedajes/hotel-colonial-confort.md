...
caracteristicas:
  ...
  - texto: Wifi
    pendiente: false
  - texto: Ambiente tranquilo
    pendiente: false
  - texto: Solo para mayores de edad
    pendiente: false
...
pruebaSocial:
  ...
  extractos:
    - texto: Ocupamos todo el hotel entre el 26 y 29 de junio, excelente servicio y precios razonables; el sitio perfecto para descansar, muy tranquilo.
      autor: Fredy Mendez
      fecha: Hace 2 meses al 4 de septiembre de 2026
antesDeReservar:
