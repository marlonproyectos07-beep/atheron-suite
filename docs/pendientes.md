...
| ~~F3.5~~ | **CERRADO el 10 sep 2026.** La sección «Nuestra historia» de la portada usa ya los dos párrafos autorizados por dirección, alineados con el artículo: los turistas de China «continuaron su viaje hacia Bogotá» y la visita permitió «identificar una oportunidad». Se retiraron «no tenía cómo recibirlos: faltaba alojamiento y faltaban servicios» y «el turismo crecía más rápido que su capacidad». Se conservan el resto de la sección (con tildes corregidas) y el enlace a la historia completa | — |
