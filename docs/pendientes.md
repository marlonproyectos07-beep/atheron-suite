...
| # | Pendiente | Quién |
|---|---|---|
| **F3.1** | **Revisar «~50 km» antes de volver a publicarlo.** *Actualizado el 10 sep 2026:* **retirado ya de la portada y de la landing de hospedaje**, sustituido por «al norte de Bogotá», sin ninguna cifra. **Sigue en las seis fichas borrador** `src/content/hospedajes/hospedaje-02.md` a `hospedaje-07.md` (`valor: ~50 km`): hay que corregirlo **antes de publicar cualquiera de ellas**. **No se asume que sea distancia lineal ni vial.** Antes de publicarla hay que definir cuatro cosas: **origen** (qué punto de Bogotá: Portal Norte, centro, aeropuerto…), **destino** (centro de Zipaquirá, Catedral, cada hospedaje), **ruta** (qué vía, si es por carretera) y **fuente** (con fecha de consulta). Mientras tanto la guía práctica del blog ya no da la cifra: dice «al norte de Bogotá, en la provincia de Sabana Centro». Por orden de dirección, **las seis fichas borrador no se tocan todavía** | Marlon define origen, destino y ruta · Claude verifica y ejecuta |
| **F3.2** | **El grupo internacional de «Cómo nació Atheron Suite»: sin cifras hasta nueva confirmación.** La experiencia es real, pero la distribución numérica quedó inconsistente en la transcripción. **No publicar** 60 personas, 10 noches, 15 en el apartamento, 55 en dos casas, «dos casas y un apartamento» ni ninguna suma o reparto. Mientras tanto el artículo usa la redacción sin números aprobada por dirección. *Cerrado el 10 sep 2026, por confirmación directa de Marlon Parra:* los turistas de China (redacción autorizada), «aproximadamente dos años» y «opera y profesionaliza siete hospedajes». Todo va como testimonio empresarial, con nota al final del artículo, no como estadística oficial | Marlon reconfirma las cifras |
...
| **F3.5** | **La portada cuenta la historia con la versión antigua.** La sección «Nuestra historia» de `src/pages/index.astro` sigue diciendo que llegaron cerca de mil turistas de China «y Zipaquirá no tenía cómo recibirlos: faltaba alojamiento y faltaban servicios», y que «el turismo crecía más rápido que su capacidad». Contradice la redacción autorizada el 10 sep 2026, que **no** afirma que se fueran por falta de hoteles. No se tocó porque la orden limitaba la historia al artículo. Hay que alinearla con «Cómo nació Atheron Suite» (redacción autorizada y nota de testimonio) antes del merge | Dirección autoriza · Claude ejecuta |
