...
function anotaSeguimiento(transaccion, entrada, ahora = /* @__PURE__ */ new Date()) {
...
async function opinar(entrada, deposito = almacen(), ahora = /* @__PURE__ */ new Date()) {
  for (let intento = 0; intento < 3; intento++) {
    ...
    if (cambio !== "CONFLICTO") {
      registra("anotar el seguimiento", new Error(`El almac\xE9n respondi\xF3 ${cambio}.`));
...
// servidor/seguimiento.ts
var seguimiento_default = maneja("POST", async (peticion) => {
...
export {
  seguimiento_default as default
};
